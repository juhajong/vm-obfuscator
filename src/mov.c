...
void v_mov(v_registers* v_regs, int size)
{
    ...
    unsigned char op1_reg_bit  = 0;
    unsigned char op1_ref_bit  = 0;
    unsigned char op1_size_bit = 0;

    unsigned char op2_reg_bit  = 0;
    unsigned char op2_ref_bit  = 0;
    unsigned char op2_size_bit = 0;
